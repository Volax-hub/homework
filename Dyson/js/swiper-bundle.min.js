    ...
    function ({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function d(t, s, a) {
        ...
        for (let e = $; e < k; e += 1)
          if (e >= M && e <= C) {
            const s = A(e);
            void 0 === f || t ? I.push(s) : (e > f && I.push(s), e < h && z.push(s));
          }
        if (
          (I.forEach((t) => {
        ...
        if ("bullets" === t.type) {
          ...
          for (let s = 0; s < a; s += 1)
            t.renderBullet
              ...
              : (r += `<${t.bulletElement} ${e.isElement ? 'part="bullet"' : ""} class="${
                  t.bulletClass
                }"></${t.bulletElement}>`);
        }
        "fraction" === t.type &&
          ...
          i.forEach((s) => {
            "custom" !== t.type && P(s, r || ""),
              "bullets" === t.type &&
                e.pagination.bullets.push(...s.querySelectorAll(oe(t.bulletClass)));
          }),
        ...
        (s.scale = A || $),
          ...
          !t || (1 === o && A)
            ...
            : ((L = h.slideEl.offsetWidth),
              ...
              (C = -T),
              (P = -M),
              I > 0 && A && "number" == typeof f.currentX && "number" == typeof f.currentY
                ? ((u = (f.currentX * s.scale) / I), (m = (f.currentY * s.scale) / I))
