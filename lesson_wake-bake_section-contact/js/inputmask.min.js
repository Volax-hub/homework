      ...
      function (module, exports, __webpack_require__) {
        ...
        function importAttributeOptions(npt, opts, userOptions, dataAttribute) {
          function importOption(option, optionData) {
            (optionData =
              void 0 !== optionData ? optionData : npt.getAttribute(dataAttribute + "-" + option)),
              null !== optionData &&
        ...
        (DependencyLib.prototype = {
          ...
          (DependencyLib.each = function (obj, callback) {
            ...
            if (isArraylike(obj))
              ...
              for (i in obj) if (((value = callback.call(obj[i], i, obj[i])), !1 === value)) break;
            return obj;
          }),
      ...
      function (module, exports, __webpack_require__) {
        ...
        function analyseMask(mask, regexMask, opts) {
          ...
          function groupQuantifier(matches) {
            ...
            return (
              lastMatch.isQuantifier && (lastMatch = groupify([matches.pop(), lastMatch])),
              lastMatch
            );
          }
          for (
      ...
      function (module, exports, __webpack_require__) {
        ...
        module.exports = function maskScope(actionObj, maskset, opts) {
              ...
              if (!0 === baseOnInput && maskset.validPositions[pos])
                (testPos =
                  ...
                  (!0 === maskset.validPositions[pos].generatedInput ||
                    (maskset.validPositions[pos].input == opts.skipOptionalPartCharacter &&
                      0 < pos))
                ...
                (testPos = getTestTemplate(pos, ndxIntlzr, pos - 1)),
                  ...
                  (ndxIntlzr = testPos.locator.slice());
                var jitMasking =
                  !0 !== noJit && (!1 !== opts.jitMasking ? opts.jitMasking : test.jit);
                (jitRenderStatic =
                  (jitRenderStatic &&
                    test.static &&
          ...
          function getLocator(tst, align) {
            var locator = (
              null != tst.alternation ? tst.mloc[getDecisionTaker(tst)] : tst.locator
            ).join("");
            ...
            if (-1 < pos && (void 0 === maxLength || pos < maxLength)) {
              if (void 0 === ndxIntlzr) {
                for (
                  ...
                  void 0 ===
                    (test = maskset.validPositions[previousPos] || maskset.tests[previousPos]) &&
                  -1 < previousPos;
          ...
          function alternate(maskPos, c, strict, fromIsValid, rAltPos, selection) {
            ...
            return (
              (returnRslt && !1 === opts.keepStatic) || delete maskset.excludes[decisionPos],
              returnRslt
            );
          }
              ...
              if (void 0 === maskset.validPositions[ps] && !isMask(ps, !0)) {
                ...
                if (vp) {
                  ...
                  if (
                    ...
                    return (
                      (maskset.validPositions[newPos] = void 0), isValid(newPos, cvpInput, !0, !0)
                    );
                  }
                }
              }
            ...
            if (
              ...
              for (
                ...
                if (
                  ...
                  !0 !== t.generatedInput &&
                  (end <= i ||
                    (begin <= i && IsEnclosedStatic(i, positionsClone, { begin: begin, end: end })))
                ) {
                  for (; "" !== getTest(posMatch).match.def; ) {
                    if (
                      !1 !== (canMatch = positionCanMatchDefinition(posMatch, t, opts)) ||
                      "+" === t.match.def
                    ) {
              ...
              if (!valid)
                return (
                  (maskset.validPositions = $.extend(!0, {}, positionsClone)), resetMaskSet(!0), !1
                );
            } else
              validTest &&
          ...
          function seekNext(pos, newBlock, fuzzy) {
            ...
            for (
              ...
              ((!0 === newBlock &&
                (!0 !== getTest(position).match.newBlockMarker || !isMask(position, void 0, !0))) ||
          ...
          function getPlaceholder(pos, test, returnPL) {
            if (
              ((test = test || getTest(pos).match), void 0 !== test.placeholder || !0 === returnPL)
            )
            ...
            EventHandlers = {
              keydownEvent: function keydownEvent(e) {
                ...
                if (
                  ...
                  (k === keyCode.HOME && !e.shiftKey) || k === keyCode.PAGE_UP
                    ...
                    : ((opts.undoOnEscape && k === keyCode.ESCAPE) || (90 === k && e.ctrlKey)) &&
                      !0 !== e.altKey
              ...
              inputFallBackEvent: function inputFallBackEvent(e) {
                ...
                if (buffer !== inputValue) {
                  ...
                  switch (
                    ((input.inputmask.shadowRoot || document).activeElement !== input &&
                      input.focus(),
          ...
          function mask(elem) {
            function isElementTypeSupported(input, opts) {
              ...
              return (
                !1 !== isSupported ? patchValueProperty(input) : (input.inputmask = void 0),
                isSupported
              );
            }
            EventRuler.off(elem);
      ...
      function (module, exports, __webpack_require__) {
        ...
        function formatcode(match) {
          ...
          if (dynMatches && void 0 !== dynMatches[0]) {
            ...
            return (
              (fcode[0] = fcode[0](dynMatches[0])), (fcode[3] = fcode[3](dynMatches[0])), fcode
            );
          }
      ...
      function (module, exports, __webpack_require__) {
        ...
        function decimalValidator(chrs, maskset, pos, strict, opts) {
          ...
          return opts._radixDance && result && null == maskset.validPositions[radixPos]
            ? {
                insert: { pos: radixPos === pos ? radixPos + 1 : radixPos, c: opts.radixPoint },
                pos: pos,
              }
            : result;
        }
          ...
          numeric: {
                  ...
                  if (!opts.digitsOptional) {
                    if (caretPos.begin > radixPos && caretPos.end <= radixPos)
                      return c === opts.radixPoint
                        ? {
                            insert: { pos: radixPos + 1, c: "0", fromIsValid: !0 },
                    ...
                    if (buffer[buffer.length - 1] === opts.negationSymbol.front) {
                      ...
                      "" !== opts.radixPoint &&
                        ...
                        (result && result.buffer
                          ? result.buffer.shift()
                          : (buffer.shift(),
                            (result = { refreshFromBuffer: !0, buffer: stripBuffer(buffer) })));
            ...
            onKeyDown: function onKeyDown(e, buffer, caretPos, opts) {
              ...
              if (
                ...
                if (
                  buffer[e.keyCode === keyCode.DELETE ? caretPos.begin - 1 : caretPos.end] ===
                  opts.negationSymbol.front
                )
                  return (
        ...
        if (document.head.createShadowRoot || document.head.attachShadow) {
          var InputmaskElement = (function (_HTMLElement) {
            function InputmaskElement() {
              ...
              return (
                new _inputmask.default().mask(input), (input.inputmask.shadowRoot = shadow), _this
              );
            }
